...
session_start(); 
...

	{
		...
		echo '<p style="text-align: center;"><input type="submit" onclick=" location.href="check_session.php" " value="Вернуться" class = "default_button"></p>';
		...
		// Параметры для подключения
							...
							$myrow_of_log = mysqli_fetch_array($result_of_log); // Запись полученного результата в массив
											...
											echo '<h1 style="font-style:italic" align="center"> Таблица: engine_room </h1></br>';
											...
											echo '<form action = "outputEdit.php" method="post" align = "center">
																			<input type="checkbox" name="edit_this" value="1"/>Таблица «engine_room»<br>
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_1_1" placeholder="ID_записи" />	
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_1_2" placeholder="Название машзала" />						
																			<input required type="submit" name="but_1" value="Изменить"/>
																			<br/><br/><br/>
											...
											echo '<h1 style="font-style:italic" align="center"> Таблица: rack</h1></br>';
											...
											do{
												echo '<tr>'
														.'<td style="font-weight: bold;align :center;color:red">'.$myrow_of_log['id_eng_room'].'</td>'
														.'<td align = "center">'.$myrow_of_log['id_rack'].'</td>'
											...
											echo '<form action = "outputEdit.php" method="post" align = "center">
																			...
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_2_1" placeholder="ID_записи" />						
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_2_3" placeholder="Имя стойки" />	
																			<input type="submit" name="but_1" value="Изменить"/>
																			<br/><br/><br/>
											...
											echo '<h1 style="font-style:italic" align="center"> Таблица: unit</h1></br>';
											...
											do{
												echo '<tr>'
														...
														.'<td align = "center">'.$myrow_of_log['id_unit'].'</td>'
											...
											echo '<form action = "outputEdit.php" method="post" align = "center">
																			...
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_3_1" placeholder="ID_записи" />	
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_3_2" placeholder="Название юнита" />	
																			<input type="submit" name="but_1" value="Изменить"/>
																			<br/><br/><br/>
											...
											echo '<h1 style="font-style:italic" align="center"> Таблица: server</h1></br>';
											...
											do{
												echo '<tr>'
														...
														.'<td align = "center">'.$myrow_of_log['id_server'].'</td>'
											...
											echo '<form action = "outputEdit.php" method="post" align = "center">
																			...
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_4_1" placeholder="ID записи" />						
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_4_3" placeholder="Имя сервера" />	
																			<input required style="text-align:center" maxlength="25" size="40" name="edit_4_4" placeholder="Тип сервера" />	
																			<input type="submit" name="but_1" value="Изменить"/>
																			<br/><br/><br/>
...
<meta charset="utf-8">
<title>Изменение строк</title></head><body></body></html>